            ...
            <swiper ref="mySwiper" class="swiper" :options="swiperOptions" @ready="onSwiperRedied"  @clickSlide="onSwiperClickSlide">
                <swiper-slide v-for="item in projectContent" :key="item.id">
                    <div class="kproject swiper-slide">
                        <img :src="require('../../public/assets/img/project/' + item.image)" class="img-fluid" alt="project_img">
        ...
        return {
            ...
            projectContent: [{
                ...
                },
                {
                    ...
                    category: 'Facility',
                    title: '180 degrees view of swimming pool',
                    titleUrl: '/#',
                    projectLinkUrl: '/#',
                },
                {
