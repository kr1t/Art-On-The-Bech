            ...
            <div class="col-lg-8">
                <div class="kquality mb-30" data-aos="zoom-in-right">
                    <div class="kquality-icon">
                        <i><img :src="require('../../public/assets/img/icon/service-icon-4a.png')" class="img-fluid z-index" alt="about-img"></i>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="text-lg-end mb-30" data-aos="zoom-in-left">
                    <div class="kquality-img">
                        <img :src="require('../../public/assets/img/trust/' + image)" class="img-fluid" alt="cta-img">
                    </div>
                </div>
            </div>
        </div>
